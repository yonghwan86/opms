            ...
            {wti ? (
              <>
                <div className="flex items-center justify-between gap-2">
                  ...
                  {fx && (
                    <div className="flex flex-col items-end shrink-0 border border-border rounded-lg px-2.5 py-1.5 bg-muted/70 dark:bg-muted/50">
                      <span className="text-sm md:text-base font-bold text-foreground whitespace-nowrap leading-tight">{fmt(Math.round(fx.rate))}원/달러</span>
